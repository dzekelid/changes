...
- name: Getty Images Get Asset Change Notifications
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/changes/master/_listings/getty-images/v3-asset-changes-change-sets-put.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/changes/master/_listings/getty-images/v3-asset-changes-change-sets-put-postman.md
x-common:
