...
- name: Akamai API Cancel a Change
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/changes/master/_listings/akamai/cps-v2-enrollments-enrollmentid-changes-changeid-delete.md
x-common:
- type: x-base
